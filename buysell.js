...
const sellToken = async ()=>{
    ...
    const transaction = await Transfer_function.swapExactTokensForTokensSupportingFeeOnTransferTokens(
        ...
        Date.now() + 1000 * 60 * 5,
        {
            gasLimit: private_data.GAS_LIMIT_TO_SELL_TOKEN,
            gasPrice: private_data.GWEI_TO_SELL_TOKEN
        }
    );
...
//         const slippagePercentage = 5; // Assuming 1% slippage
...
//     } catch (err) {
//         console.error(`Error in selling tokens: ${err.message}`);
//     }
// };
